    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-9">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a id="notgoingTab" class="nav-link" onclick="fetchEvents('notgoing', 'notgoingTab')">Not Going</a>
                </li>
            </ul>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-around mt-3">
                                <button type="button"
                                    ...
                                    data-event-id="{{ $event->event_id }}" data-status="going"><i class="fas fa-check me-1"></i>Going</button>
                                <button type="button"
                                    class="btn {{ $response && $response->status == 'interested' ? 'btn-warning' : 'btn-outline-warning' }} btn-status"
                                    data-event-id="{{ $event->event_id }}" data-status="interested"><i class="fas fa-star me-1"></i>Interested</button>
                                <button type="button"
                                    class="btn {{ $response && $response->status == 'not_going' ? 'btn-danger' : 'btn-outline-danger' }} btn-status"
                                    data-event-id="{{ $event->event_id }}" data-status="not_going"><i class="fas fa-times me-1"></i>Not going</button>
                            </div>
                        </div>
                    </div>
                </div>
